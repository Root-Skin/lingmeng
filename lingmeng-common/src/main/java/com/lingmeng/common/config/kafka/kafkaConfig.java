 ...
 * @Description kafka基本配置
 */
@Configuration
public class kafkaConfig {
    @Value("${spring.kafka.bootstrap_servers_config}")
    private String bootstrap_servers_config;

    @Value("${spring.kafka.retries_config}")
    private int retries_config;

    @Value("${spring.kafka.batch_size_config}")
    private int batch_size_config;

    @Value("${spring.kafka.linger_ms_config}")
    private int linger_ms_config;

    @Value("${spring.kafka.buffer_memory_config}")
